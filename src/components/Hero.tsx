          ...
          <div className="lg:col-span-5 w-full reveal-on-scroll animate-float-slow">
            <div className="w-full bg-brand-dark-card border border-brand-dark-border rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6 font-mono text-xs leading-relaxed text-gray-400 overflow-x-auto">
                <div>
                  <span className="text-blue-400">import</span> {'{'} <span className="text-amber-400">Foundation</span>, <span className="text-amber-400">Student</span> {'}'} <span className="text-blue-400">from</span> <span className="text-brand-pink">"gclick-core"</span>;
                </div>
                ...
                <div className="pl-4">
                  <span className="text-gray-300">location</span>: <span className="text-brand-pink">"Winneba, Ghana"</span>,
                </div>
                <div className="pl-4">
                ...
                <div className="pl-4">
                  <span className="text-gray-300">name</span>: <span className="text-brand-pink">"Ekow Mensah"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-gray-300">focusTrack</span>: <span className="text-brand-pink">"Full Stack Web"</span>,
                </div>
                <div className="pl-4">
                  <span className="text-gray-300">mentorshipCohort</span>: <span className="text-brand-pink">"12-Week Sprint"</span>
                </div>
                <div>{'}'}));</div>
                ...
                <div className="mt-2 text-brand-pink font-semibold animate-pulse">
